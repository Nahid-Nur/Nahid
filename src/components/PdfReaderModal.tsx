...
import { X, Download, ZoomIn, ZoomOut, BookOpen, ChevronLeft, ChevronRight, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-900/95 backdrop-blur-md animate-fadeIn">
      ...
      <div className="h-16 bg-slate-900 border-b border-slate-800 flex items-center justify-between px-6 text-white shrink-0">
        ...
        {/* Reader Controls */}
        <div className="hidden sm:flex items-center space-x-3 bg-slate-800 px-3 py-1.5 rounded-xl border border-slate-700">
          <button
        ...
        <div className="flex items-center space-x-3">
          <div className="hidden md:flex items-center space-x-1 bg-slate-800 px-2 py-1 rounded-lg border border-slate-700">
            <button
